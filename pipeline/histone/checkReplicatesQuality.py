...
def get_bigwig_files(samples):
    ...
    for sample in samples:
        bigwig_file = f'../2_signal/{sample}.bw'
...
def process_signal(name, target_regions_file, bigwig_files, labels):
    ...
    if corr.shape[0] < 3:  # less than 3 replicates
        return
    corr_3 = {}
...
def main():
    ...
    cmd = f'python3 {MY_PATH}/histone_summary.py replicates_check'
    subprocess.call(cmd.split())
    # os.rename(
    #     src='HM_summary_replicates_check_fragments_length.csv',
    #     dst=
    #     'replicates_quality_check/HM_summary_replicates_check_fragments_length.csv'
    # )
    os.rename(
        src='Histone_summary_replicates_check_mapping_info.csv',
        dst=
        'replicates_quality_check/Histone_summary_replicates_check_mapping_info.csv'
    )
    #
